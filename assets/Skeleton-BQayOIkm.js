...
`)),L=A("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,e)=>{const{ownerState:n}=t;return[e.root,e[n.variant],n.animation!==!1&&e[n.animation],n.hasChildren&&e.withChildren,n.hasChildren&&!n.width&&e.fitContent,n.hasChildren&&!n.height&&e.heightAuto]}})(({theme:t,ownerState:e})=>{const n=W(t.shape.borderRadius)||"px",a=B(t.shape.borderRadius);return o({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:N(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},e.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${a}${n}/${Math.round(a/.6*10)/10}${n}`,"&:empty:before":{content:'"\\00a0"'}},e.variant==="circular"&&{borderRadius:"50%"},e.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},e.hasChildren&&{"& > *":{visibility:"hidden"}},e.hasChildren&&!e.width&&{maxWidth:"fit-content"},e.hasChildren&&!e.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&c(m||(m=l`
    ...
    `),D,(e.vars||e).palette.action.hover)),z=S.forwardRef(function(e,n){const a=M({props:e,name:"MuiSkeleton"}),{animation:i="pulse",className:s,component:r="span",height:h,style:y,variant:C="text",width:k}=a,p=j(a,P),d=o({},a,{animation:i,component:r,variant:C,hasChildren:!!p.children}),w=T(d);return E.jsx(L,o({as:r,ref:n,className:O(w.root,s),ownerState:d},p,{style:o({width:k,height:h},y)}))});export{z as S};
